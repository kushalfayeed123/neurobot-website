...
export default function Home() {
  return (
    <main className="min-h-screen">
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Experience the future of currency trading with our advanced AI bot.
      ...
      <section className="py-20 bg-dark-lighter">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <h3 className="text-2xl font-bold text-primary mb-4">AI Signals</h3>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">Link your trading account securely</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-20 bg-dark-lighter">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <MotionDiv
              whileHover={{ scale: 1.05 }}
              className="p-8 rounded-lg bg-dark border-2 border-secondary"
            >
              <h3 className="text-2xl font-bold text-secondary mb-4">Pro</h3>
              <p className="text-4xl font-bold mb-6">$199<span className="text-lg">/mo</span></p>
              <ul className="space-y-4 mb-8">
            ...
            >
              ...
              <p className="text-4xl font-bold mb-6">$399<span className="text-lg">/mo</span></p>
              <ul className="space-y-4 mb-8">
      ...
      <section className="py-20">
        <div className="container-custom">
          <h2 className="text-4xl font-bold text-center mb-16">What Our Traders Say</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <MotionDiv
            ...
            >
              ...
              <p className="text-gray-300 mb-4">
                "Neurobot.ai has completely transformed my trading strategy. The AI signals are incredibly accurate, and I've seen a 35% increase in my monthly returns since I started using the platform."
              </p>
            ...
            >
              ...
              <p className="text-gray-300 mb-4">
                "The backtested strategies and real-time market analysis have given me confidence in my trading decisions. The 24/7 automation feature is a game-changer for someone who can't monitor the markets constantly."
              </p>
              <div className="flex text-yellow-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            ...
            >
              ...
              <p className="text-gray-300 mb-4">
                "As someone who manages a significant portfolio, I need reliable tools. Neurobot.ai's advanced algorithms and custom strategies have been instrumental in optimizing my trading performance."
              </p>
              <div className="flex text-yellow-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Revolutionizing currency trading through advanced AI technology and machine learning algorithms.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">AI Trading Signals</a></li>
                <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Automated Trading</a></li>
                <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Market Analysis</a></li>
                <li><a href="#" className="text-gray-300 hover:text-primary transition-colors">Custom Strategies</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">123 Trading Street, Suite 100<br />New York, NY 10001</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              &copy; {new Date().getFullYear()} Neurobot.ai. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
